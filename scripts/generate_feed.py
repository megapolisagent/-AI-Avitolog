...
Что НЕ делает:
  - не проверяет достоверность цены (это market_snapshot_analyzer.py; сравнение с эталоном
    застройщика убрано 2026-09-17 вместе с ЖК Алия — эталона сейчас нет)
...
полей в data/lots/TEMPLATE.md (добавить их — значит расширить шаблон входных данных, не делать
этого без прямого решения владелицы), а Title/Description — не сырые данные лота, а готовый текст карточки (заголовок и
